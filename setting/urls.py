...
urlpatterns = patterns('',
       ...
       url(r'^users/edit/(?P<user_id>[0-9]+)/$',
           views.add_edit_user, name='edit_user'),

       url(r'^groups/$', views.groups_list,
           name='groups_list'),
       ...
       url(r'^clients/$', views.clients_list,
           name='clients_list'),
       ...
       url(r'^clients/shutdown/(?P<client_id>[0-9]+)/$',
           views.shutdown_client, name='shutdown_client'),
